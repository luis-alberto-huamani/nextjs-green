...
// EXTERNAL MODULE: ./pages/foo.scss
var foo = __webpack_require__("SsP/");

// EXTERNAL MODULE: ./components/perf/header.scss
var header = __webpack_require__("oP3p");

// EXTERNAL MODULE: ./components/perf/btn-upload.jsx
var btn_upload = __webpack_require__("r7lJ");
...
var header_PerfilHeader = function PerfilHeader(_ref) {
  ...
  return external_react_default.a.createElement("header", {
    ...
    className: "col-12"
  }, owner && external_react_default.a.createElement(btn_upload["a" /* default */], {
    id: "frontPage",
...
/* harmony default export */ var perf_header = (header_PerfilHeader);
// EXTERNAL MODULE: ./components/perf/quote.scss
var perf_quote = __webpack_require__("t+Yh");

// CONCATENATED MODULE: ./components/perf/quote.jsx
...
var quote_Quote = function Quote(_ref) {
  var isOpen = _ref.isOpen,
      ...
      quote = _ref.quote;
  return external_react_default.a.createElement(external_reactstrap_["Modal"], {
    isOpen: isOpen
  }, isOpen && external_react_default.a.createElement(external_reactstrap_["ModalBody"], {
    style: {
      padding: "5px 10px"
    }
  }, external_react_default.a.createElement("div", {
...
/* harmony default export */ var components_perf_quote = (quote_Quote);
// EXTERNAL MODULE: external "uuid/v1"
var v1_ = __webpack_require__("CUYq");
...
// CONCATENATED MODULE: ./pages/perf.jsx
...
function (_Component) {
  ...
  function Perfil(props) {
    ...
    _this = Object(possibleConstructorReturn["a" /* default */])(this, Object(getPrototypeOf["a" /* default */])(Perfil).call(this, props));
    _this.state = {
      id: '',
      perfilImg: '',
      perfilLoader: false,
    ...
    _this.handleChangeImg = _this.handleChangeImg.bind(Object(assertThisInitialized["a" /* default */])(_this));
    _this.onQuote = _this.onQuote.bind(Object(assertThisInitialized["a" /* default */])(_this));
    _this.onFriendReq = _this.onFriendReq.bind(Object(assertThisInitialized["a" /* default */])(_this));
    _this.accpetFriend = _this.accpetFriend.bind(Object(assertThisInitialized["a" /* default */])(_this));
    _this.cancelFriendReq = _this.cancelFriendReq.bind(Object(assertThisInitialized["a" /* default */])(_this));
    _this.onConfirmation = _this.onConfirmation.bind(Object(assertThisInitialized["a" /* default */])(_this));
    _this.rmFriend = _this.rmFriend.bind(Object(assertThisInitialized["a" /* default */])(_this));
    return _this;
  }
  ...
  Object(createClass["a" /* default */])(Perfil, [{
    ...
    value: function handleChangeImg(e) {
      ...
      if (img) {
        ...
        this.setState(Object(defineProperty["a" /* default */])({}, loader, true));
        fetch("/api/upload/".concat(stateImg), options).then(function (res) {
          if (res.status === 200) {
            res.text().then(function (resp) {
              var _this2$setState;

              _this2.setState((_this2$setState = {}, Object(defineProperty["a" /* default */])(_this2$setState, stateImg, resp), Object(defineProperty["a" /* default */])(_this2$setState, loader, false), _this2$setState));
            });
          }
        });
      }
    ...
    key: "accpetFriend",
    value: function () {
      var _accpetFriend = Object(asyncToGenerator["a" /* default */])(
      /*#__PURE__*/
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                _context.next = 5;
                return external_axios_default.a.get("/aceptFriend/".concat(targetId));
    ...
    key: "onFriendReq",
    value: function () {
      var _onFriendReq = Object(asyncToGenerator["a" /* default */])(
      /*#__PURE__*/
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                ...
                id = this.state.id;
                _context2.next = 5;
                return external_axios_default.a.get("/sendFriendReq/".concat(id));
    ...
    key: "cancelFriendReq",
    value: function () {
      var _cancelFriendReq = Object(asyncToGenerator["a" /* default */])(
      /*#__PURE__*/
          ...
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                ...
                id = this.state.id;
                _context3.next = 4;
                return external_axios_default.a.get("/cancelFriendReq/".concat(id));
    ...
    key: "rmFriend",
    value: function () {
      var _rmFriend = Object(asyncToGenerator["a" /* default */])(
      /*#__PURE__*/
          ...
          while (1) {
            switch (_context4.prev = _context4.next) {
              case 0:
                ...
                id = this.state.id;
                _context4.next = 4;
                return external_axios_default.a.get("/rmFriend/".concat(id));
    ...
    value: function render() {
      ...
      return external_react_default.a.createElement(layout["a" /* default */], null, external_react_default.a.createElement(components_perf_quote, {
        isOpen: quoteVisible,
        onQuote: this.onQuote,
        handleChange: this.handleChange,
        quote: frontPageQuote,
        owner: owner
      }), external_react_default.a.createElement(external_reactstrap_["Modal"], {
        isOpen: confirmationMsg
      }, external_react_default.a.createElement(external_reactstrap_["ModalBody"], null, external_react_default.a.createElement("div", {
        className: "confirmation_cont"
      }, external_react_default.a.createElement("p", null, "Seguro que desea eliminar a ", external_react_default.a.createElement("span", null, fullName)), external_react_default.a.createElement("div", {
        ...
        color: "secondary"
      }, "No"), external_react_default.a.createElement(external_reactstrap_["Button"], {
        size: "sm",
        onClick: this.rmFriend,
        color: "success"
      }, "Si"))))), external_react_default.a.createElement(perf_header, {
        user: {
          id: id,
          perfilImg: perfilImg,
          fullName: fullName,
...
Object(defineProperty["a" /* default */])(perf_Perfil, "getInitialProps", function (_ref) {
...
/* harmony default export */ var perf = __webpack_exports__["default"] = (perf_Perfil);
...
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("cDcd");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _btn_upload_scss__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__("h8BI");
