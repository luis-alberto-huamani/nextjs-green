...
module.exports = __webpack_require__("e0Vf");
...
var Perfil = function Perfil(_ref) {
  var user = _ref.user;
  return react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement("div", null, react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement("h1", null, "hola"), console.log(user));
};

Perfil.getInitialProps =
/*#__PURE__*/
function () {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            id = query.id;
            _context.next = 4;
            return isomorphic_unfetch__WEBPACK_IMPORTED_MODULE_3___default()("http://localhost:4000/api/perfil/".concat(id));
