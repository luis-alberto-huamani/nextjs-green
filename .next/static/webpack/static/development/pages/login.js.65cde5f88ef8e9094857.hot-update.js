        ...
        fetch('http://localhost:4000', {
          ...
          if (res.status === 201) {
            ...
            res.text().then(function (resp) {
              localStorage.setItem('id', resp); //Router.push(`https://nextjs-green.now.sh/perfil?id=${resp}`);

              window.location = " https://nextjs-green.now.sh/perfil?id=".concat(resp);
            });
          } else {
            _this2.setState({
              fail: true,
...
//# sourceMappingURL=login.js.65cde5f88ef8e9094857.hot-update.js.map