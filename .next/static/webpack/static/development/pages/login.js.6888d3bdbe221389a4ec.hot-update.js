        ...
        fetch('http://localhost:4000', {
          ...
          if (res.status === 201) {
            ...
            res.text().then(function (resp) {
              ...
              next_router__WEBPACK_IMPORTED_MODULE_15___default.a.push("https://nextjs-green.now.sh/perfil?id=".concat(resp));
            });
          } else {
            _this2.setState({
              fail: true,
...
//# sourceMappingURL=login.js.6888d3bdbe221389a4ec.hot-update.js.map