        ...
        fetch('http://localhost:4000/api/login', {
          ...
          if (res.status === 201) {
            ...
            res.json().then(function (resp) {
              ...
              localStorage.setItem('heart', resp.comments);
              localStorage.setItem('friendReq', resp.friendReq);
              localStorage.setItem('commets', resp.comments);
              console.log(resp);
              var payload = {
...
//# sourceMappingURL=login.js.7a07148cad8af8bd08de.hot-update.js.map