        ...
        fetch('http://localhost:4000/api/login.js', {
          ...
          if (res.status === 201) {
            ...
            res.json().then(function (resp) {
              console.log(resp);
              Object(_store_actions__WEBPACK_IMPORTED_MODULE_18__["onUser"])({
                action: _store_actions__WEBPACK_IMPORTED_MODULE_18__["userAction"].LOG_IN,
                data: resp
              });
              next_router__WEBPACK_IMPORTED_MODULE_15___default.a.push("/perfil");
            });
          } else {
            _this2.setState({
              fail: true,
...
/* harmony default export */ __webpack_exports__["default"] = (Object(react_redux__WEBPACK_IMPORTED_MODULE_17__["connect"])(null, mapStateToProps)(Login));

/***/ })

})
//# sourceMappingURL=login.js.e7fba9cb6ed3327b100f.hot-update.js.map