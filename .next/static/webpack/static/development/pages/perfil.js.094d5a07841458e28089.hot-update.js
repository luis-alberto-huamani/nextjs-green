...
function (_Component) {
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_3__["default"])(PerfilNav, [{
    ...
    key: "handleFriend",
    value: function handleFriend(action, e) {
      var currentUser = localStorage.getItem('id');
      var targetUser = e.target.id;
      var data = {
        currentUser: currentUser,
      ...
      if (action === 'add') {
        isomorphic_unfetch__WEBPACK_IMPORTED_MODULE_9___default()("http://localhost:4000/api/friend/add/".concat(e.target.id), options);
      }

      if (action === 'rm') {
        isomorphic_unfetch__WEBPACK_IMPORTED_MODULE_9___default()("http://localhost:4000/api/friend/rm/".concat(e.target.id), options);
      }
    }
  }, {
    key: "render",
...
//# sourceMappingURL=perfil.js.094d5a07841458e28089.hot-update.js.map