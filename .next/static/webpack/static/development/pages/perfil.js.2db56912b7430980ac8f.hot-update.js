    ...
    value: function render() {
      ...
      /*friendReq.map((item, i) => (
        <div className="friend_cont">
          <img width={100} src={item.perfilImg} alt=""/>
          <span>{item.name}</span>
        </div>
      ))*/
      console.log(friendReq))))), react__WEBPACK_IMPORTED_MODULE_8___default.a.createElement(reactstrap__WEBPACK_IMPORTED_MODULE_13__["TabPane"], {
        tabId: "4",
        __source: {
          fileName: _jsxFileName,
          lineNumber: 199
...
//# sourceMappingURL=perfil.js.2db56912b7430980ac8f.hot-update.js.map